...
def main(file_path, srt_path=None, detection_id=None):
    try:
        ...
        if is_video:
            ...
            ffmpeg_path =  r"C:\Users\Indah\Downloads\ffmpeg-2025-05-29-git-75960ac270-essentials_build\ffmpeg-2025-05-29-git-75960ac270-essentials_build\bin\ffmpeg.exe"  # sesuaikan dengan milikmu
